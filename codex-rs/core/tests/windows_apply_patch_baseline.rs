...
async fn run_baseline() -> Result<()> {
    ...
    // Exclude first-run account/setup provisioning from measured operations.
...
async fn run_patch(
    ...
    let result = BaselineResult {
        ...
        setup_refresh_child_execution_ms: child_ms,
        setup_refresh_orchestration_estimated_ms: stats.setup_refresh_total_ms - child_ms,
    };
    println!(
